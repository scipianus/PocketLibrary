...
public class DetectBookByCoverActivity extends AppCompatActivity {
    ...
    private SortedSet<DatabaseBookEntry> mDatabaseEntries;
    private List<BookEntry> mDatabaseEntriesList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detect_book_by_cover);
        ...
        mBookEntryAdapter = new BookEntryAdapter(mDatabaseEntriesList);
            ...
            public void run() {
                try {
                    ...
                    for (lineCounter = 1; lineCounter <= DATABASE_ENTRIES; ++lineCounter) {
                        ...
                        mDatabaseEntries.add(new DatabaseBookEntry(idTokens[1], getDistance(features, mFeatures)));
